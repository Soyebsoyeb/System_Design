...
public:
    ...
    // It is kept virtual , the reason is that it will not 
    // only destroy Base but also Child object if Base is used 
    // as a pointer for reference  durign Instantiation
